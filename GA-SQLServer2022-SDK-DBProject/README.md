...
```bash
./SqlPackage /Action:Publish /SourceFile:bin/Debug/GA_SQLServer2022_SDK_DBProject.dacpac /TargetServerName:localhost /TargetDatabaseName:GA_SQLServer2022_SDK_DBProject
```
